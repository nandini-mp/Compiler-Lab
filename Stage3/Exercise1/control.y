...
%token <no> ID NUM
%token PLUS MINUS MUL DIV BEGINN ENDD READ WRITE ASSIGN SEMICOLON LT GT LE GE NE EQ IF THEN ELSE ENDIF WHILE DO ENDWHILE
%left PLUS MINUS
%left MUL DIV
...
program : BEGINN Slist ENDD SEMICOLON { evaluateAndPrint($2); exit(0);}
