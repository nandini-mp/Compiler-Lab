...
enum nodeTypes {
	Nadd, Nsub, Nmul, Ndiv, Nassign, Nconnect, Nvar, Nconst, Nread, Nwrite, Nif, Nifelse, Ngt, Nlt, Nge, Nle, Nne, Neq, Nwhile, Nbreak, Ncontinue, Nrepeat, Ndowhile, Ndecl, Ntype, Nstr, Narr, Narraccess, Naddr, Nderef, Nmod, Nfdecl, Nfdef, Nparam, Nfcall, Nreturn
};
