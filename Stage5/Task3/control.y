...
program : GDeclBlock FDefBlock MainBlock { ASTRoot = makeConnectNode($1, makeConnectNode($2, $3));  }
...
GDecl : Type {current_type = $1->type;} GidList SEMICOLON {$$ = makeDeclNode($1,$3);}
	;
...
LDecl : Type {current_type = $1->type;} IdList SEMICOLON {$$ = makeDeclNode($1,$3);}
	;
...
Decl : Type {current_type = $1->type;} Varlist SEMICOLON { $$ = makeDeclNode($1, $3); }
	;
...
Stmt : InputStmt {$$ = $1;}
	...
	| RETURNN expr SEMICOLON { $$ = makeReturnNode($2); }
	;
